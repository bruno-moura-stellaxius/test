...
function calculateItemValue(mainItem){
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////
    var deferreds = [];
if (me.getBoOrderMeta().getComputePrice() !== "4" && me.getBoOrderMeta().getComputePrice() !== "5" && mainItem.getMyIsPrdFlattenedByAgreements() != "1" && mainItem.getMyIsPrdFlattenedByCommercialPolicies() != "1"){
  ...
  mainItem.modified = [];
  var parsedValue = Number.parseFloat((prices.value).toFixed(2));
  ...
  deferreds.push(mainItem.setValue(parsedValue));
