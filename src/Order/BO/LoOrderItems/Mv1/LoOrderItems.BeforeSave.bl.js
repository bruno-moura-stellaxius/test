...
for (var i=0; i<items.length; i++){
  ...
  if(items[i].listed == 'false') items[i].listed = '0';
  if(items[i].listed == 'true') items[i].listed = '1';

  if(items[i].promoted == 'false') items[i].promoted = '0';
  if(items[i].promoted == 'true') items[i].promoted = '1';
  
  if(items[i].history == 'false') items[i].history = '0';
  if(items[i].history == 'true') items[i].history = '1';
  
  if(items[i].outOfStock == 'false') items[i].outOfStock = '0';
  if(items[i].outOfStock == 'true') items[i].outOfStock = '1';

  if(items[i].changedBOMType == 'false') items[i].changedBOMType = '0';
  if(items[i].changedBOMType == 'true') items[i].changedBOMType = '1';
} //End For (items)
