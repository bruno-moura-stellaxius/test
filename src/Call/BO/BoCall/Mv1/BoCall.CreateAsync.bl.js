...
if (
  ...
  promise = BoFactory.loadObjectByParamsAsync(
    ...
    .then(function () {
      if(me.getDistributionIssue() === "true") me.setDistributionIssue('1');
      if(me.getOutOfStockIssue() === "true") me.setOutOfStockIssue('1');
      if(me.getAllDay() === "true") me.setAllDay('1');
      
      if(me.getDistributionIssue() === "false") me.setDistributionIssue('0');
      if(me.getOutOfStockIssue() === "false") me.setOutOfStockIssue('0');
      if(me.getAllDay() === "false") me.setAllDay('0');
      
      if(me.getDistributionIssue() == ' ') me.setDistributionIssue('0');
      if(me.getOutOfStockIssue() == ' ') me.setOutOfStockIssue('0');
      if(me.getAllDay() === ' ') me.setAllDay('0');
