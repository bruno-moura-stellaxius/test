      ...
      function (listJobProducts) {
        for (var idxProduct = 0; idxProduct < listJobProducts.length; idxProduct++) {
          ...
          if (posId === " ") {
            ...
            if (liSurveyColumn && liSurveyColumn.getPresetting() === "LastValue") {
            ...
            else if (liSurveyColumn && liSurveyColumn.getPresetting() === "TargetValue") {
        ...
        if (listJobProducts.length > 0) {
          ...
          loProducts.orderBy({"shortText":"ASC"});
        }
