 ...
 * @returns promise
 */
function loadAndSetPrerequisites(loadType, boCall,surveyType){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
...
if (!Utils.isDefined(me.getLoMyAccountPromotion())) {
  deferreds.push(BoFactory.loadLightweightListAsync("LoMyAccountPromotion", jsonQuery).then(
    function (list) {
      me.setLoMyAccountPromotion(list);
    }
  ));
}
if (!Utils.isDefined(me.getLoMyTrainings())) {
  deferreds.push(BoFactory.loadLightweightListAsync("LoMyTrainings", jsonQuery).then(
    function (list) {
      me.setLoMyTrainings(list);
    }
  ));
}
