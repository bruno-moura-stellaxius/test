...
{               
  ...
  {                   
    ...
    case "primaryContact":
      primaryContact = jsonQuery.params[index].value;
      break;
  }
}
...
switch (context)
{
  ...
  case "Address":
    ...
    break;
  case "Contact":
    let actionEnabled = !primaryContact ? "1" : "0";
    menuItem = me.createMenuItem("0000001","TrashcanDarkGrey24","Delete", "DeleteContact", actionEnabled);
    if (Utils.isDefined(menuItem))
    {
      contextMenuItemList.push(menuItem);
    }              
