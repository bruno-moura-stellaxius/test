...
me.setPhone2(" ");
me.setEmail1(" ");
me.setMyPrimaryContact(false); // SAP(Primary) Contacts are imported
me.setFax1(" ");
me.setEmailEditable("1");
me.setMyEmail2(" ");
me.setMyEmail2Editable("1");
me.updateProperties(jsonQuery);
var promise =  BoFactory.loadListAsync("LoMyMainFunction", {"pl_condition": " AND length(trim(code__c)) <= 2" })
.then(function(loMyMainFunction) {
  me.setLoMyMainFunction(loMyMainFunction);
  return BoFactory.createListAsync(LO_CONTACTPARTNERADDRESS, {'params': []});
})
.then(
  function (object) {
