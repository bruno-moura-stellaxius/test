...
var myLoadAllSellSheets = function (result) {
  idsOfSalesFoldersForSync = me.removeLocalIDs(me.getPropertyValuesFromArray(result.MySalesFolders, "salesFolderId"));
  if (idsOfSalesFoldersForSync.length > 0) {
    request.addRequest('NFT_MySalesFolderSellSheet', idsOfSalesFoldersForSync);  
  }
}; 
  ...
  promise = me.getWorkingDays().then(
    function (workingDayRange){
      sqlBulkJsonArray = [
        ...
        {
          dataSource       : "DsBoSfReplicationCallbacks",
          dataSourceMethod : "MySalesFolders",
          jsonParams       : {},
          uniqueReturnKey  : "MySalesFolders"	
        },
        {
          dataSource       : "DsBoSfReplicationCallbacks",
