...
var mainOrder = Framework.getProcessContext().orderBo

if(Utils.isDefined(mainOrder) && ((mainOrder.boOrderMeta.id == 'Exchange' && mainOrder.myExchangeType == 'Exchange') || (Utils.isDefined(mainOrder.luMyVisit.pKey)))){
  return when.resolve(3);
}
