...
orderItems.forEach(function(item) {
  if((item.getQuantity() > 0 || item.getMyTotalQuantity() > 0)) {
...
orderItems.forEach(function(item) {
  if(uomPKeyDict.containsKey(item.getRefPKey().trim() + item.getSdoParentItemPKey().trim()) && item.getShowInFreeGoods() === "0" && (item.getQuantity() > 0 || item.getMyTotalQuantity() > 0)) {
