 ...
 * @function myValidateStartApproval
 * @this BoOrder
...
function myValidateStartApproval(){
    ...
    if((me.boOrderMeta.id == "PreSales" || me.boOrderMeta.id == "Cycle") && me.luOrderer.myCustStat == '0110' && me.luOrderer.mySalesOrg == 'C155' && Utils.isEmptyString(me.myTenderIdentificationCode)){
        var newError = {
            "level": "error", 
            "objectClass": "BoOrder", 
            "messageID": "CasSdoMyOrderEmptyTenderCodeValidationMessage",
            "messageParams": {}
        };
