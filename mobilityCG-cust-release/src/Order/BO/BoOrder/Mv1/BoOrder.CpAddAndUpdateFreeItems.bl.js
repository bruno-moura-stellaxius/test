      ...
      function(){
        ...
        freeItemsToBeGenerated.forEach(function(freeItemContainer){
          ...
          item = {
            ...
            "myDeliveryUnit" : productInformationLookup.getMyDeliveryUnit(),
            "mySAPCode" : productInformationLookup.getMySAPCode(),
            "myApplyDeliveryUnit" : liItemTemplate.getMyApplyDeliveryUnit(),
            "mySalesRepQuota" : productInformationLookup.getSalesRepQuota(),
            "mySalesRepQuotaCategory" : productInformationLookup.getSalesRepQuotaCategory(),
            "mySalesRepQuotaValidFrom" : productInformationLookup.getSalesRepQuotaValidFrom(),
            "mySalesRepQuotaValidTo" : productInformationLookup.getSalesRepQuotaValidTo(),
            "myChannelQuota" : productInformationLookup.getChannelQuota(),
            "myChannelQuotaCategory" : productInformationLookup.getChannelQuotaCategory(),
            "myChannelQuotaValidFrom" : productInformationLookup.getChannelQuotaValidFrom(),
            "myChannelQuotaValidTo" : productInformationLookup.getChannelQuotaValidTo(),
            "myCustomerQuota" : productInformationLookup.getCustomerQuota(),
            "myCustomerQuotaCategory" : productInformationLookup.getCustomerQuotaCategory(),
            "myCustomerQuotaValidFrom" : productInformationLookup.getCustomerQuotaValidFrom(),
            "myCustomerQuotaValidTo" : productInformationLookup.getCustomerQuotaValidTo(),
            "orderItemTemplate" : liItemTemplate.getOrderItemTemplate(),
