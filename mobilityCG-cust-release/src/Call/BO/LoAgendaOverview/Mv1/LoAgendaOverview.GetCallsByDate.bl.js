 ...
 * @param {String} myCallCustomer
 * @returns promise
 */
function getCallsByDate(setDateFunction, filterCalls, currentDateStart, currentDateEnd, currentResponsiblePKey, numberOfListItems, cardMode, myCallCustomer){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
...
var promise = dateDefer.then(
  ...
  if (myCallCustomer) {
    jsonParams.push({"field": "callCustomer", "operator": "EQ", "value": myCallCustomer});
  }
