...
if(me.surveyType == "StoreCheck"){
  ...
  loQuestions.setFilterArray([ {"posId": posId, "op": "EQ"}, {"mySurveyTypeId" : "Store Check", "op" : "EQ"} ]);
}
if(me.surveyType == "Feedback"){
  loQuestions.resetAllFilters();
    loQuestions.setFilterArray([ {"mySurveyTypeId" : "Feedback", "op" : "EQ"} ]);
}
if(me.surveyType == "Satisfaction"){
  loQuestions.resetAllFilters();
  loQuestions.setFilterArray([ {"posId": posId, "op": "EQ"}, {"mySurveyTypeId" : "CSAT", "op" : "EQ"} ]);
}
