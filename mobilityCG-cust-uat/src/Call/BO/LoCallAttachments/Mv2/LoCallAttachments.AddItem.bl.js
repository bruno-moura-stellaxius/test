 ...
 * @param {DomBool} myOpenGallery - To differentiate between live pictures and uploads from Gallery 
 * @returns promise
 */
function addItem(mediaPath, boCall, jDTPKey, myOpenGallery){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
...
var promise = positionPromise.then(function (currentPosition) {
  ...
  var attachmentData = {
    ...
    "myPictureSource": myOpenGallery == 1 ? "Uploaded" : "Live",
