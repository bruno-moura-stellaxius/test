 ...
 * @function myEvaluateShipToSource
...
function myEvaluateShipToSource(){
    ...
    if(me.luMySplitType.pKey == 'Direct'){
        me.setConsideredCustomerToShipTo(me.billToPKey);
        me.setConsideredCustomerToBillTo(myMainOrder.luOrderer.pKey);
    }
    else{
        me.setConsideredCustomerToShipTo(myMainOrder.luOrderer.pKey);
        me.setConsideredCustomerToBillTo(me.wholesalerPKey);
    }
